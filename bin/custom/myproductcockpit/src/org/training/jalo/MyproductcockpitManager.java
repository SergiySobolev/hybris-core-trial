...
import org.training.constants.MyproductcockpitConstants;
...
/**
 * This is the extension manager of the myproductcockpit extension.
 */
public class MyproductcockpitManager extends GeneratedMyproductcockpitManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(MyproductcockpitManager.class.getName());
	 ...
	 */
	public static final MyproductcockpitManager getInstance()
	{
		return (MyproductcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyproductcockpitConstants.EXTENSIONNAME);
	}
