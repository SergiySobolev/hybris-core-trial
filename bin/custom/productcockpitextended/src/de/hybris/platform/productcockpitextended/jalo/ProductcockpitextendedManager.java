...
/**
 * This is the extension manager of the Productcockpitextended extension.
 */
public class ProductcockpitextendedManager extends GeneratedProductcockpitextendedManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductcockpitextendedManager.class.getName());
	 ...
	 */
	public static ProductcockpitextendedManager getInstance()
	{
		return (ProductcockpitextendedManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductcockpitextendedConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductcockpitextendedManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductcockpitextendedManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductcockpitextendedManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductcockpitextendedManager called, current tenant: " + getTenant().getTenantID());
		}
	}
