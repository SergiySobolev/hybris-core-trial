package de.hybris.platform.productcockpitextended.hmc;
 ...
 * @version ExtGen v4.1
 */
public class ProductcockpitextendedHMCExtension extends HMCExtension
{
    /** Edit the local|project.properties to change logging behavior (properties log4j.*). */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(ProductcockpitextendedHMCExtension.class.getName());
