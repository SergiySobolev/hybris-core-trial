...
package productcockpitextended;
...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"MyProduct",
			"Product",
			de.hybris.platform.productcockpitextended.jalo.MyProduct.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_MyProduct_someattribute();
			

	}

	
	public void single_createattr_MyProduct_someattribute() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_MyProduct_someattribute();
		
	}


		
						public void single_setAttributeProperties_MyProduct_someattribute() throws JaloBusinessException
						{
